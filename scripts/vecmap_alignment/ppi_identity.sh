OUTDIR=visualize/ppi_no_feature
...
time python vecmap/map_embeddings.py --unsupervised \
    ${OUTDIR}/original/unsup-example_data/${MODEL}_0.010000/all.emb \
    ${OUTDIR}/target/unsup-example_data/${MODEL}_0.010000/all.emb \
    ${OUTDIR}/original/unsup-example_data/${MODEL}_0.010000/vecmap.emb \
    ${OUTDIR}/target/unsup-example_data/${MODEL}_0.010000/vecmap.emb \
    --cuda

python vecmap/eval_translation.py ${OUTDIR}/original/unsup-example_data/${MODEL}_0.010000/vecmap.emb \
	${OUTDIR}/target/unsup-example_data/${MODEL}_0.010000/vecmap.emb \
