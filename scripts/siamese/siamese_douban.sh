...
DS=$HOME/dataspace/graph/douban/filtered_data
DS1=$HOME/dataspace/graph/douban/filtered_data/online
PREFIX1=online
DS2=$HOME/dataspace/graph/douban/filtered_data/offline
PREFIX2=offline
TRAIN_RATIO=0.8
LR=0.01
...
python -m graphsage.siamese_unsupervised_train --cuda True --print_every 100 --epochs 100 \
