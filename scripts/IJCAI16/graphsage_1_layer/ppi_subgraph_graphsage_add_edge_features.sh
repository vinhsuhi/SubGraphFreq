...
PREFIX1=ppi
DS2=$HOME/dataspace/graph/ppi/sub_graph/subgraph3/random_clone/add_edge,p=
PREFIX2=ppi
RATIO=0.1
LR=0.01
LOGNAME=sub_vs_sub_add_edge_feat_iden
OUTDIM=150
IDENTITYDIM=0
...
# python data_utils/random_clone_add.py --input ${DS1}/graphsage --output ${DS1}/random_clone \
#     --prefix ${PREFIX1} --nadd ${RATIO} --padd ${RATIO}
...
# python data_utils/split_dict.py --input ${DS2}${RATIO},n=${RATIO}/permutation/dictionaries/groundtruth \
# --out_dir ${DS2}${RATIO},n=${RATIO}/permutation/dictionaries/ --split ${TRAIN_RATIO}
...
# RATIO=0.1
# LR=0.01
# LOGNAME=sub_vs_sub_add_edge_feat_iden50
# OUTDIM=150
# IDENTITYDIM=50
# EMBEDDINGEPOCHS=2000
# NEGSAMPLESIZE=10
...
# RATIO=0.1
# LR=0.01
# LOGNAME=sub_vs_sub_add_edge_justfeat
# OUTDIM=150
# IDENTITYDIM=0
# EMBEDDINGEPOCHS=2000
# NEGSAMPLESIZE=10
