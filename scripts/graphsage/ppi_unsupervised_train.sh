python -m graphsage.unsupervised_train --learning_rate 0.001 --prefix dataspace/graph/karate/graphsage/karate --batch_size 10 --epochs 100 --max_degree 25 --model graphsage_mean --identity_dim 64 --save_model True --save_embeddings True --load_walks True --cuda False
